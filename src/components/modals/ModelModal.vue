...
<template>
  <div v-if="app.modelModalOpen" class="modal-backdrop model-backdrop" @mousedown.self="app.closeModelModal">
    <form class="connection-modal model-modal" role="dialog" aria-modal="true" aria-labelledby="model-modal-title" @submit.prevent="app.saveModelDraft" @keydown.esc.prevent="app.closeModelModal">
